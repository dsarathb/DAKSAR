...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ViewController *vwController = [[ViewController alloc] initWithNibName:nil bundle:[NSBundle mainBundle]];
...
- (IIViewDeckController*)generateControllerStack {
    ...
    UIViewController *centerController = [[ViewController alloc] initWithNibName:nil bundle:[NSBundle mainBundle]];
